...
import { AdminLogin, EmailSendForgotSeler, EmailSendForgotUser, SellerLogin, SellerResetPassword, SellerVerifyOtp, UserResetPassword, UserVerifyOtp } from '../API/api';
...
const ForgotPassword = () => {
    ...
    const SendEmailHandler = async (e) => {
        ...
        let res = await EmailSendForgotUser(payload);
