                      ...
                      <div class="row">
                          ...
                          <div class="col">
                              ...
                              <ul>
                                  ...
                                  <li><a href="#">Pressure cooking</a></li>
                                  <li><a href="#">Humidifier</a></li>
                                  <li><a href="#">Freezer</a></li>
                                  <li><a href="#">Toaster Oven</a></li>
                                  <li><a href="#">Electric stove</a></li>
                              </ul>
                          </div>
                          <div class="col">
                          ...
                          <div class="col">
                              ...
                              <ul>
                                  ...
                                  <li><a href="#">LG Electronics</a></li>
                                  <li><a href="#">Hitachi</a></li>
                                  <li><a href="#">Microsoft</a></li>
                                  <li><a href="#">Huawei</a></li>
                                  <li><a href="#">IBM</a></li>
                                  <li><a href="#">Fujitsu</a></li>
                                  <li><a href="#">Lenovo Group</a></li>
