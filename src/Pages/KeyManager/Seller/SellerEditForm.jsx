...
import { FileUpload, UpdateSellerData, UpdatesellerOwnRegistrationForm, allIndiaCities, allcatList, sellerDetails } from '../../../API/api';
...
const SellerEditForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let response = await UpdateSellerData(SellerId, userInfo);
...
const ShopInfo = ({ userInfo, getProfileData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        let response = await UpdateSellerData(userInfo?._id, payload);
                    ...
                    <Row className='mt-2'>
                        <Col xs={6}>
                            <Form.Group controlId="shopImages">
                                <Form.Label className='frmLable'>Shop Images <span className="req">*</span> 
                                    {shopInfo?.pic_of_shope &&
                                        <a href={shopInfo?.pic_of_shope?.[0]} target='blank'>view</a>
                                    }
                                </Form.Label>
