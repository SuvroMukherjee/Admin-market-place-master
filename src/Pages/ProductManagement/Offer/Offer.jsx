...
import { GetProductDetails, offerCreate, offerTypeCreate, offerTypeList, sellerProductDeatils } from '../../../API/api';
                ...
                <Row className='m-2 p-2 justify-content-md-center stepContent'>
                            ...
                            <Col xs={12}>
                                <Form.Group controlId="user_name">
                                    <Row>
                                        ...
                                        <Col xs={8}>
                                            <Form.Control type="text" name="hsn_code" className='tapG' placeholder='Enter Product HSN Code' size='sm' value={productId} onChange={handleChange} disabled autoComplete='off' />
                                        </Col>
                                    </Row>
                                </Form.Group>
                            </Col>
                                    ...
                                    <div className='mt-2'>
                                            ...
                                            <Col xs={12} key={index}>
                                                <div className='specText2Rest'>
                                                    <span className='specText2'>{ele?.offerId?.offer_type_name}</span> offer {ele?.discount_percentage}% discount on {ele?.offer_on?.bank_name}-{ele?.offer_on.card_type} Card
                                                </div>
                    ...
                    <Row className='mt-4'>
                        <Col xs={12} className='mt-4'>
                            <Row>
                                <Col>
                                    <Button size='sm' variant='secondary' className='cancelbtn' onClick={() => navigate('/Admin/product-offer')}>CANCEL</Button>
                                </Col>
                                <Col className='d-flex justify-content-end'>
                                    <Button size='sm' variant='success' type="submit" onClick={() => submitForm()}>DONE </Button>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
