...
const EditOwnProduct = () => {
    ...
    const {id:OwnProductId} = useParams()
    ...
    async function productDetails(){
        await SellerOwnProductDetails(OwnProductId).then((res)=>{
    ...
    const handleSubmit = async (e) => {
        ...
        if (requiredFields.every(field => formData[field])) {
            ...
            nonBlankFields["sellerId"] = userId;

            try {
                const res = await EditSellerOwnProduct(OwnProductId,nonBlankFields);
                console.log(res);
                                ...
                                <Row className='mt-2'>
                                    ...
                                    <Col>
                                        <Form.Group controlId="categoryId">
                                            ...
                                            <Form.Control as="select" name="brandId" value={formData.brandId?._id} onChange={handleChange} >
                                                <option value="" disabled selected>
                                                    Select Brand
                                                </option>
