...
const ServicesFeedback = () => {
  ...
  const SellingProducts = async () => {
    await sellerDetails(auth?.userId)
      .then((res) => {
  ...
  return (
    ...
    >
      <Row>
        <Col className="dtext">Customer Feedback</Col>
      </Row>
      <Row className="mt-4">
        <Col>
          <Table responsive>
                ...
                currentItems.map((row, index) => (
                  <tr key={row.id} className="cusfeedtd">
                    <td className="cusfeedtd">
                      <div>
                        <h4 className="cusfeedtd">{row?.desc}</h4>
                        <p className="cusfeedtd">
                          <img src={calender} width={20} />{" "}
                    ...
                    <td>
                      <div>
                        <p>
                          <img src={user} /> {row?.user?.name}
                        </p>
                        {/* <p>
                          <img src={placeholder} width={15} />{" "}
                          {row?.user?.state}
                        </p> */}
                      </div>
                    </td>
                    <td>
                      <FaStar size={30} color="gold" /> {row?.rating}
                    </td>
