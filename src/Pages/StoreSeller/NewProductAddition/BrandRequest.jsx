...
const BrandRequest = () => {
  ...
  const handleOptionInput = (value, type) => {
    if (type == "distributer") {
      setModalData({
        ...modalData,
        ["dis_doc"]: { ...modalData?.dis_doc, comment: value },
      });
    } else {
      setModalData({
        ...modalData,
        ["manu_doc"]: { ...modalData?.manu_doc, comment: value },
      });
    }
  };
              ...
              <Row className="stepContent">
                ...
                <Row className="mt-2">
                  <Col xs={12}>
                    <Form.Group controlId="title">
                      <Form.Label>
                        <span className="req mx-1">*</span>Brand Title
                      </Form.Label>
                      <Form.Control
                        type="text"
                        className="tapG"
                ...
                <Row className="mt-2">
                  <Form.Group controlId="image">
                    <Col xs={12}>
                      <Form.Group controlId="title">
                        <Form.Label>
                          <span className="req mx-1">*</span>Brand Image
                ...
                <Row className="mt-2">
                  <Form.Group controlId="title">
                    <Col xs={12}>
                      <Form.Label>
                        <span className="req mx-1">*</span>Brand Origin{" "}
                      </Form.Label>
              ...
              <div className="mt-4">
                ...
                <Row>
                  <Col className="mt-2 infotext">
                    At least 1 purchase invoice for products from a manufacturer
                    or distributor
                  </Col>
                </Row>
